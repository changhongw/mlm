...
def compute_baseline_alignment(seg_lnum, top_percent, method, candi_ratio):
    ...
    path_save = os.path.join(data_dir, 'test_alignment_output', f'seg{seg_lnum}_{method}_topk{top_percent}')
    ...
    if method == "random":
        ...
        for batch in tqdm(batches):
            ...
            select_idx = torch.randperm(len(x)-1)
